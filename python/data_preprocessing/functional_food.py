...
def create_functional_food_file():
    ...
    with req.urlopen(url) as response:
        ...
        with open('./data/functional_food.txt','x',encoding='utf-8-sig') as f:
            f.write(data)
...
if not path.isfile('./data/functional_food.txt'):
    create_functional_food_file()

with open('./data/functional_food.txt','r',encoding='utf-8-sig') as f:
    str_data=f.read()
